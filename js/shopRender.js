...
window.YYCardShopRender = (function() {
            ...
            if (render.isValidCard(original)) {
                ...
                if (isCharacterCard(original) && (bonusAtk > 0 || bonusHp > 0)) {
                    ...
                    displayCard = {
                        ...
                        hp:  baseHp  + bonusHp,
                        base_atk: (original.base_atk || 0) + bonusAtk,   // 防止内部逻辑回退
    ...
    // getShopDisplayCards 同样需要叠加加成（给姜子牙等外部使用）

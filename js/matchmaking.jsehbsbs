// ==================== 匹配系统（修复重连覆盖状态 + 加强清理版 + 新增 gameStartTime + isReady） ====================
window.YYCardMatchmaking = (function() {
    ...
    // ========== 改进：setCurrentRoom 加入 cleanup，确保重连时清除旧状态 ==========
    function setCurrentRoom(roomId) {
        cleanup();                     // 清除旧的订阅和超时定时器
...
console.log('✅ matchmaking.js 加载完成（含 isReady 初始化，且 setCurrentRoom 已加强清理）');

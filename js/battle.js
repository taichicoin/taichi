...
window.YYCardBattle = (function() {
    ...
    let lastPhase = null;
    let thisBattleRound = 0; // 记录当前战斗阶段的回合，避免重复触发动画
    ...
    // 供外部获取实时阶段（shop.js 中的 getCurrentPhaseFromBattle 可调用）
    ...
    // 启动战斗动画（由前端 combat.js 本地模拟，后端 settle-battle 稍后对接）
...
console.log('✅ battle.js 完整稳定版已加载');

...
window.YYCardBattle = (function() {
    ...
    function renderBattleUI() {
        ...
        // 注意：刷新和升级按钮现在只有商店区域的一组（id 为 refresh-shop-btn 和 buy-exp-btn）
        // 它们始终显示，但点击时内部会检查阶段和金币，无需额外隐藏
        // 不再操作已删除的底部按钮
    }
...
console.log('✅ battle.js 加载完成【修复按钮合并兼容版】');

...
window.YYCardBattle = (function() {
    ...
    function injectCombatCss() {
        ...
        style.textContent = `
            ...
            @keyframes attack{0%{transform:translateX(0);}50%{translateX(8px);}100%{translateX(0);}}
    ...
    async function tick() {
        ...
        // 关键修复：刚进入战斗阶段时播放动画
        if (currentPhase !== phase && phase === 'battle' && !isAnimating) {
            log("⚔️ 进入战斗阶段，播放战斗动画");
            await simulateBattleWithAnimation();
        }

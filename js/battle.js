...
window.YYCardBattle = (function() {
    ...
    // ★ 合并玩家数据：当前用户跳过 shopCards，金币带3秒保护
    ...
    async function enterBattle(roomId) {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            if (state) {
                ...
                const aliveCount = Object.values(gameState.players).filter(p => !p.isEliminated && p.health > 0).length;
...
console.log('✅ battle.js 已修复：重连不再覆盖商店状态');

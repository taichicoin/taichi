...
window.YYCardBattle = (function() {
    ...
    async function tick() {
        ...
        // 进度条和跳过按钮的显示仍然基于真实的 phase（时间计算出的）
        const displayPhase = (window.YYCardShop?.getForcePrepareMode && window.YYCardShop.getForcePrepareMode()) ? 'prepare' : phase;

        if (displayPhase === 'battle') {
        ...
        // 更新 lastPhase，但要考虑到绿色通道可能改变了实际显示的阶段

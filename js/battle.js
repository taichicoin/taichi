...
window.YYCardBattle = (function() {
    ...
    async function refreshGameState() {
        ...
        // 1. 如果正在播放动画，只更新“对手”的状态，不碰“自己”的数据
        if (isAnimPlaying && currentUserId) {
            ...
            // 注意：完全不更新当前玩家自己的数据，保持动画中的临时状态
            return;
        }

        // 2. 非动画状态，正常合并更新（保持现有逻辑不变）

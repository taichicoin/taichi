...
window.YYCardBattle = (function() {
    ...
    // 动画核心逻辑：无CSS注入，完全依赖外置CSS，加三重防重锁
    ...
    // 严格遵循流程：动画仅在阶段切换时触发一次，不改动任何UI布局逻辑
    ...
    // 纯UI显示，彻底移除动画和业务逻辑，避免和onPhaseEnd打架
    async function tick() {
...
console.log('✅ battle.js 加载完成（CSS动画完全外置版）');

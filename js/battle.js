...
window.YYCardBattle = (function() {
    ...
    function ensureSkipUI() {
        ...
        container.id = 'battle-progress-container';
        container.style.cssText = `
            position: fixed; left: 5%; width: 90%; z-index: 90; pointer-events: none;
        `;
        ...
        bar.style.cssText = `
            height: 100%; background: linear-gradient(90deg, #ff8800, #f5d76e);
        ...
        skipBtn.style.cssText = `
            display: none; position: fixed; left: 5%; z-index: 91; pointer-events: auto;
            background: rgba(20, 28, 48, 0.9); color: #f5d76e; border: 1px solid #f5d76e;
            border-radius: 6px; padding: 4px 12px; font-size: 0.7rem; font-weight: bold;

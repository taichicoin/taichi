// ==================== 纯时间驱动对战系统【完整版·含 pendingConsumables 支持】 ====================
window.YYCardBattle = (function() {
    ...
    let pollingInterval = null;       // 已废弃，保留变量但不再使用
    let mainTimer = null;
    ...
    // ========== ★ 新增：本地时间偏移，替代每秒RPC ==========
    let serverTimeOffset = 0; // 服务器秒数 - 本地秒数
    ...
    // ★★★ 修改：applyPSettlement 增加 pendingConsumables 处理 ★★★
    ...
    // ★★★ 修改：fetchGameState 增加 pendingConsumables 字段 ★★★
    async function fetchGameState(roomId) {
        ...
        players[myId] = {
            ...
            rank: myData.rank,
            pendingConsumables: myData.pendingConsumables || []   // ★ 新增
        };
    ...
    // ★★★ 战斗动画启动（不变，但内部调用 applyPSettlement 已更新） ★★★
    ...
    // ★★★ 修改：subscribeGameState 中处理 pendingConsumables ★★★

...
window.YYCardBattle = (function() {
    ...
    let isPlayingAnimation = false;      // 防止动画重复触发
    ...
    async function tick() {
        ...
        if (currentPhase !== phase) {
            ...
            // 从准备阶段进入战斗阶段 -> 播放战斗动画
            if (currentPhase === 'prepare' && phase === 'battle' && !isPlayingAnimation && !isSettling) {
...
console.log('✅ battle.js 加载完成（轮询保护 + 缓冲期变暗 + 战斗动画）');

...
window.YYCardBattle = (function() {
    ...
    async function fetchGameState(roomId) {
        ...
        return {
            ...
            lastSettledRound: globalRow.lastSettledRound || 0   // ★ 读取已结算回合
        };
    }
        ...
        for (let i = 0; i < 20; i++) {
            ...
            if (state) {
                ...
                if (currentPhase === 'battle' && !myPlayer?.isEliminated) {
                    ...
                    launchBattleAnimation(); // 内部判断是否已结算
                }

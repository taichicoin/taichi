// ==================== 对战系统【纯时间驱动版 + 状态机根治锁 + 强制同步UI + 轮询保底】 ====================
window.YYCardBattle = (function() {
    ...
    function applyUIMode(isPrepare) {
        ...
        // ===== 新增：进入战斗模式时强制刷新 UI，确保敌方棋盘显示最新数据 =====
        if (!isPrepare && window.YYCardShop?.refreshAllUI) {
...
console.log('✅ battle.js 加载完成（对手UI实时刷新版 + 轮询保底 + 写入修复 + 战斗UI强制刷新）');

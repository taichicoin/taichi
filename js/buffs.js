    ...
    async function selectBuff(buffId) {
        ...
        try {
            ...
            if (gameState?.players?.[userId]) {
                ...
                gameState.players[userId]._checkedActiveBuff = true;
            }
            ...
            if (window.YYCardShop) {
                ...
                if (window.YYCardShop.renderShop) window.YYCardShop.renderShop();
                if (window.YYCardShop.updateRefreshButtonDisplay) window.YYCardShop.updateRefreshButtonDisplay();
            }
            if (window.YYCardBattle?.renderPlayerStatus) {
                window.YYCardBattle.renderPlayerStatus();
            }

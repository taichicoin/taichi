...
window.YYCardCombat = (function() {
    ...
    function ensureDebugPanel() {
        ...
        title.style.cssText = 'font-weight:bold; margin-bottom:6px; color:#ff0;';
    ...
    function buffAnim(buff) {
        return new Promise(resolve => {
            ...
            if (!el) {
                debugLog(`增益动画未找到元素: player=${buff.playerId.slice(0,8)} pos=${buff.position}`);
                return resolve();
            }

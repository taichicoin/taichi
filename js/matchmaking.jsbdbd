    ...
    async function initializeGame(roomId, players) {
        ...
        try {
            ...
            for (const p of players) {
                ...
                if (weapons.length > 0) handCards.push({...weapons[0], star: weapons[0].star || 0});
...
console.log('✅ matchmaking.js 加载完成（玩家独立行 + 全局行）');

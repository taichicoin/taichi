...
window.YYCardRender = (function() {
    ...
    // 手牌渲染已移至 handRender.js，此处不再定义 renderHand
    ...
    function refreshAllUI() {
        ...
        renderMyBoard();
        // 调用独立的手牌渲染模块
        if (window.YYCardHandRender && window.YYCardHandRender.renderHand) {
            window.YYCardHandRender.renderHand();
        }
        renderShop();
    ...
    return {
        ...
        createCardElement,
        renderMyBoard,
        // renderHand 已移除，由 handRender.js 提供
        renderShop,
        renderBoard,
        getShopDisplayCards,
        refreshAllUI,

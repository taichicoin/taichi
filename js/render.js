...
window.YYCardRender = (function() {
    ...
    function createCardElement(card, cardType = 'board', isBoard = false) {
        ...
        iconDiv.innerHTML = `<img src="${imgPath}" alt="${display.name}" onerror="this.src='/assets/default-avatar.png'">`;
        iconDiv.querySelector('img').draggable = false;
        ...
        // 5. 护盾占位（由 buffs.js 动态添加，这里不用动，只要 overflow:visible 就行）
        return d;
    }

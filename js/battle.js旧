...
window.YYCardBattle = (function() {
    ...
    function startPhaseTimer(phase, duration, skipStateUpdate = false) {
        ...
        clearAllTimers(); // 现在会同时清除 safetyTimer
...
console.log('✅ battle.js 加载完成（递增回合 + 缓冲2s + 结算3s + 安全超时修复 + 准备阶段卡00修复）');

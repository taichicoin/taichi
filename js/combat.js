...
window.YYCardCombat = (function() {
    ...
    function ensureLogPanel() {
        ...
        panel.style.cssText = `
            ...
            padding: 8px; border-radius: 6px; border: 1px solid #0f0;
            overflow-y: auto; z-index: 100002; font-family: monospace;
            pointer-events: auto; text-shadow: 0 0 4px black;
            white-space: pre-wrap; line-height: 1.5;
        `;
        panel.innerHTML = '<div style="color:#0f0; text-align:center; border-bottom:1px solid #0f0; margin-bottom:6px;">⚔️ 战斗日志 ⚔️</div>';
    ...
    function appendLogEntry(text) {
        ...
        entry.style.cssText = 'border-bottom: 1px solid #0f0; margin-bottom: 6px; padding-bottom: 6px;';

// ==================== 战斗模拟模块（独立渲染敌方棋盘，镜像布局正确，不再依赖 shop） ====================
window.YYCardCombat = (function() {
    ...
    function renderEnemyBoardFromData(oppId, oppBoardData) {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            // 敌方 data-board-index 映射：视觉前排(0-2)对应数据 3-5，后排(3-5)对应数据 0-2
        ...
        debugLog(`🔧 已按镜像布局渲染敌方棋盘，对手ID: ${oppId.slice(0,8)}`);
    }

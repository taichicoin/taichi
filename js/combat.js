...
window.YYCardCombat = (function() {
    ...
    function spawnWeaponOnCard(cardEl) {
        ...
        // 让剑尖指向屏幕右方（世界 +X），然后旋转使宽面朝向相机
        const rightTarget = pos.clone().add(new THREE.Vector3(1, 0, 0));
        weapon.lookAt(rightTarget);
    ...
    function flyWeaponToTarget(weapon, startPos, defEl) {
        ...
        return new Promise(resolve => {
            ...
            const duration = 440;        // 飞行时长 0.44 秒
    ...
    function attackAnim(a) {
        return new Promise(async resolve => {
            ...
            if (_3DReady) {
                ...
                await new Promise(r => setTimeout(r, 500)); // 放大停留 0.5 秒

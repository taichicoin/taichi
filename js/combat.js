// ==================== 战斗模拟模块（最终稳定版：基于玩家ID定位棋盘 + 死亡移除 + 慢速动画） ====================
window.YYCardCombat = (function() {
    ...
    panelLog('✅ combat.js 最终稳定版 (死亡移除修复+慢速动画)');

    // 通过玩家ID和棋盘数据索引获取卡牌元素（只返回 .card 元素）
    ...
    function playAttackAnim(a) {
        return new Promise(resolve => {
            ...
            $att.style.transition = 'transform 0.25s ease-out';
            ...
            setTimeout(() => {
                ...
                dmgDiv.style.cssText = 'position:absolute; color:#f44; font-size:28px; font-weight:bold; text-shadow:0 0 8px #000; z-index:200; left:50%; top:40%; transform:translate(-50%,-50%); animation:damageFloat 0.8s forwards; pointer-events:none;';
                ...
                setTimeout(() => {
                    ...
                    if (a.isFatal) {
                        ...
                        setTimeout(resolve, 200); // 非致命也稍慢一点
                    }
                }, 180); // 受击停顿稍长
            }, 250); // 攻击前摇
        });

            ...
            if (step.type === 'buff') {
                ...
                if (isMyEvent && step.goldGain) {
                    ...
                    if (my) {
                        ...
                        if (goldDisplay) {
                            floatingText(goldDisplay, `💰 +${step.goldGain}`, '#f5d76e', 1500);
                        }
                        debugLog(`  💰 金币 +${step.goldGain}，当前金币：${my.gold}`);
                    }
                    // 跳过正常的 buffAnim（金币不需要棋盘动画）
                } else if (isMyEvent) {
                    await buffAnim(step);

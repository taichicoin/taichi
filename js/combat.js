...
window.YYCardCombat = (function() {
    ...
    // 在卡牌上生成平放的武器（剑尖朝上，宽面朝向相机）
    function spawnWeaponOnCard(cardEl) {
        const THREE = _threeModule;
        ...
        weapon.rotateZ(Math.PI / 2);   // 宽面朝向屏幕

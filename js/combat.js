// ==================== 战斗模拟模块（最终稳定版：技能增益 + 轮流攻击 + 死亡移除 + 慢速动画） ====================
window.YYCardCombat = (function() {
    ...
    panelLog('✅ combat.js 完整版 (技能增益+轮流攻击+死亡移除+慢速)');
        ...
        for (const playerId in gameState.players) {
            ...
            for (let pos = 0; pos < 6; pos++) {
                ...
                if (skill.type === 'enlightenment') {
                    ...
                    // 毕方：暂不实现生成消耗牌，仅记录
                    else if (skill.skillId === 'skill_xianhuo_shoufa') {

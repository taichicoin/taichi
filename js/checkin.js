...
window.YYCardCheckin = (function() {
  ...
  function injectStyles() {
    ...
    s.textContent = `
      ...
      .checkin-box { background: rgba(255,255,255,0.3); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); border-radius: 0; padding: 24px; width: 85%; max-width: 340px; color: #1a1a2e; text-align: center; box-shadow: 0 8px 32px rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.4); }
      ...
      .checkin-notice { color: #333; font-size: 0.95em; margin: 15px 0; }
    `;
    ...
    if (!hasTelegram) {
      ...
      modal.innerHTML = `
        <div class="checkin-box">
          <h3>📅 签到</h3>
          <div class="checkin-notice">请在 Telegram 中使用此功能</div>

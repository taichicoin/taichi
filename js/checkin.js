...
window.YYCardCheckin = (function() {
  ...
  function injectStyles() {
    ...
    s.textContent = `
      ...
      /* 弹窗：30%白色透明，无圆角，保留模糊 */
      .checkin-box { background: rgba(255,255,255,0.3); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); border-radius: 0px; padding: 24px; width: 85%; max-width: 340px; color: #1a1a2e; text-align: center; box-shadow: 0 8px 32px rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.4); }

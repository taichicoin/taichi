    ...
    if (!document.getElementById('sidebtn-common-style')) {
        ...
        style.textContent = `
            ...
            .genshin-side-btn {
                ...
                right: 20px;
                z-index: 1000;
                width: 50px;            /* 72 * 0.7 ≈ 50 */
                height: 66px;           /* 94 * 0.7 ≈ 66 */
                border-radius: 17px;    /* 24 * 0.7 ≈ 17 */
            ...
            .icon-wrap {
                width: 40px;            /* 58 * 0.7 ≈ 40 */
                height: 40px;
                margin: 4px auto 0;     /* 顶部对齐，左右自动居中（宽度40 < 按钮50） */
                border-radius: 50%;
            ...
            .btn-text {
                position: absolute;
                bottom: 5px;            /* 原来8px，缩小比例 */
                width: 100%;
                text-align: center;
                color: #fff;
                font-size: 11px;        /* 15 * 0.7 ≈ 11 */
                font-weight: 600;
                letter-spacing: 0.7px;  /* 1 * 0.7 */

...
window.YYCardBattle = (function() {
    ...
    // ============ 【修复版】视图切换核心函数 =============
    // true = 准备阶段：显示商店，隐藏敌方棋盘、分割线
    // false = 战斗阶段：隐藏商店，显示敌方棋盘、分割线
    ...
    async function enterBattle(roomId) {
        ...
        // 稳健等待：主动重试查询，不依赖单次订阅
        let attempts = 0;
        const MAX_ATTEMPTS = 15; // 15次 * 200ms = 3秒
    ...
    function subscribeToGame(roomId) {
        ...
        gameSubscription = supabase
            ...
            .subscribe();
        // 初始查询已在 waitForState 中主动进行，此处不再重复
    }
...
console.log('✅ battle.js 加载完成【双阶段布局修复版】');

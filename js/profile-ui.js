// ========== 大厅UI交互（中英双语版 · 无修改头像 · 显示当前邮箱 · 已移除强制用户名/改名卡） ==========
window.YYCardProfileUI = {
    ...
    update() {
        ...
        // ★ 移除改名卡显示，按钮不再依赖 username
        const cardCountEl = document.getElementById('lobby-card-count');
...
console.log('✅ 头像菜单已更新：无修改头像，显示当前登录邮箱，已移除用户名强制与改名卡');

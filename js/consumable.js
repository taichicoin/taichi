...
window.YYCardConsumable = (function() {
    ...
    function showSelectionPanel() {
        try {
            ...
            `;
            // ★ 确认按钮改用独立内联样式，避免被全局 .btn-primary 定位干扰
            panel.innerHTML = `
    ...
    function init(deps) {
        ...
        // ★ 劫持 forceRefreshState，重连后自动更新徽章（无轮询）
        ...
        console.log('✅ consumable.js 已初始化 (无轮询修正版)');
    }

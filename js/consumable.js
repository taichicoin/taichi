// ==================== 消耗牌系统模块 (consumable.js · Edge Function 安全调用版) ====================
window.YYCardConsumable = (function() {
    ...
    // ★ 改为调用 Edge Function use-consumable
    ...
    // ★ 改为调用 Edge Function use-consumable-all
    ...
    function init(deps) {
        ...
        console.log('✅ consumable.js 已初始化（Edge Function 安全版）');
    }

// ==================== 战斗模拟模块（3D 武器攻击版 · 受击音效 · 遗言飞刀 · 刀尖朝向修复 · 曹操全体护盾优化 · 遗言金币处理 · 共工减半debuff动画 · 连续buff支持 · 亡魂召唤 · 内力连击动画） ====================
            ...
            if (step.type === 'summon_spirit') {
                ...
                if (step.summoned && step.position >= 0) {
                    ...
                    if (slotEl) {
                        ...
                        const star = isBoss ? 1 : 0;          // 终结者使用1星边框

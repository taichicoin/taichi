...
window.YYCardShop = (function() {
    ...
    const BOARD_TO_HAND_FUNCTION_URL = 'https://sznjaotjoljaiawbvfro.supabase.co/functions/v1/board-to-hand';  // 新增
...
console.log('✅ shop.js 加载完成（后端刷新商店 + 后端购买/交换 + 后端出售 + 后端放置 + 后端移回手牌 + 弹窗调试）');

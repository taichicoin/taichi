...
window.YYCardShop = (function() {
    ...
    function onDragStart(e, type, card, index, element) {
        ...
        // 【优化4：所有数据预存到dragState，拖拽中只读不写DOM】
        dragState = {
            active: true,
            type,
            card,
        ...
        // 【优化5：事件绑定用最简逻辑，移除不必要的监听】
        document.addEventListener('pointermove', onDragMove);
        document.addEventListener('pointerup', onDragEnd);
        document.addEventListener('pointercancel', onDragEnd);
    }

    // 【优化6：拖拽移动只做最核心的transform更新，零DOM查询、零重排】
    function onDragMove(e) {
        ...
        // 【核心性能飞跃】用transform: translate3d更新位置，GPU直接渲染，零重排
...
console.log('✅ shop.js 加载完成（极致流畅毫秒级拖拽版）');

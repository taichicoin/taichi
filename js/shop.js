...
window.YYCardShop = (function() {
    ...
    function renderShop() {
        ...
        if (!Array.isArray(group) || group.length < 15) {   // ★ 改为 < 15
    ...
    function isLocalFlipSafe() {
        ...
        return next && Array.isArray(next) && next.length === 15;   // ★ next 长度必须为15
    }
    ...
    function init() {
        ...
        bindUIEvents();
        refreshAllUI();
        console.log('✅ 商店系统 (每组15张，5页，乐观秒切) 已启动');
    }

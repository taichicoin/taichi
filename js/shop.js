// ==================== 商店与交互系统【全接口免JWT·RPC终极适配版 + 双缓冲商店v3（已移除敌方棋盘渲染）】 ====================
window.YYCardShop = (function() {
    ...
    function refreshAllUI() {
        ...
        // 敌方棋盘完全由 combat.js 接管，此处不再执行 renderEnemyBoard
        renderShop();
    ...
    function injectStyles() {
        ...
        style.textContent = `
            ...
            .card { 
                ...
                position: relative; 
                overflow: visible !important; /* 允许超出卡牌边框的内容显示 */
                contain: none !important; /* 取消渲染范围限制，彻底解决外部内容被裁剪 */
            }
            .card-drag-clone { 
                pointer-events: none !important; 
                will-change: left, top; 
                transform: translateZ(0); 
                overflow: visible !important; /* 拖拽克隆体也允许外部价格显示 */
            }
            ...
            .card-slot { 
                ...
                overflow: visible !important; /* 卡槽也取消裁剪，避免价格被父容器裁掉 */
            }
            
            /* ✅ 价格标签核心样式：移至卡牌外部下方、紧贴边框 */
            .card[data-card-type="shop"] .card-price {
                display: block !important;
                position: absolute !important;
                bottom: -18px !important; /* 卡牌外部，紧贴底部边框（数值可微调，-16~-20都可） */
                left: 0 !important;
                right: 0 !important;
                text-align: center !important;
                font-weight: bold !important;
                font-size: 0.8rem !important;
                z-index: 999 !important; /* 最高层级，确保不被其他元素遮挡 */
                /* 背景全透明，无任何边框阴影 */
                background: transparent !important;
                border: none !important;
                box-shadow: none !important;
                /* 文字强制白色+多层阴影，确保任何背景下都清晰可见 */
    ...
    function init() {
        ...
        bindUIEvents();
        refreshAllUI();
        console.log('✅ 全接口免JWT·RPC适配版 + 双缓冲商店v3 初始化完成 (价格移至卡牌外部修复版)');
    }

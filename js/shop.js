...
window.YYCardShop = (function() {
    ...
    let toastTimer = null;
    const domCache = {};
    let isRefreshingShop = false;        // 网络请求进行中 + 本地UI保护锁
    ...
    // ★ 不再用 isRefreshingShop 限制全局操作，只检查阶段和机器人
    function canOperate() {
    ...
    function refreshAllUI() {
        // ★ 保护：如果正在刷新中，完全不允许外部通过 refreshAllUI 重绘商店

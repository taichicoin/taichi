...
window.YYCardShop = (function() {
    ...
    function renderEnemyBoard() {
        ...
        if (oppId && gameState.players[oppId]) {
            ...
            // 敌方视觉镜像：前排显示数据索引 3,4,5；后排显示 0,1,2
    ...
    // ========== 核心修改：renderBoard 为所有卡槽设置 data-board-index ==========
    function renderBoard(containerId, cards, isSelf) {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            if (isSelf) {
                ...
                // 敌方镜像：视觉 0,1,2 对应数据 3,4,5；视觉 3,4,5 对应数据 0,1,2
    ...
    function onDragEnd(e) {
        ...
        // 移除拖拽克隆
        if (cloneElement && cloneElement.parentNode) cloneElement.remove();
        // 还原原卡牌显示，彻底消除残影

...
window.YYCardShop = (function() {
    ...
    function renderHand() {
        ...
        const CARD_WIDTH = 23; // vw
        const OVERLAP = 18;    // 每张牌左侧被遮挡的宽度，露出 23-18=5vw

        // 从右向左添加，使左侧牌在 DOM 上层，盖住右侧牌
        for (let i = total - 1; i >= 0; i--) {
            ...
            // 第一张牌（最左侧）不需要负margin，其余牌向左缩进 OVERLAP
            if (i === 0) {
                el.style.marginRight = '0vw';
            } else {
                el.style.marginRight = `-${OVERLAP}vw`;
            }

...
window.YYCardShop = (function() {
    ...
    function createCardElement(card, cardType = 'board', isBoard = false) {
        ...
        d.style.cssText = `
            ...
            padding: 0 !important;
            margin: 0 !important;
            overflow: visible !important; /* 关键：允许内容溢出格子 */
            display: flex;
            align-items: center;
        ...
        // ★【终极改动】使用绝对定位放在正中心，强制移除 100% 宽高限制，仅让图片保持原比例并居中轻微放大
        // 这样可以彻底突破网格 aspect-ratio 的限制，做到“不受限于格子之内”！
        d.innerHTML = `
            <img src="${imgPath}" 
                 alt="${display.name}" 

...
window.mergeService = (function() {
    ...
    function playFlyAnimation(sourceElements, targetElement, duration = 600) {
        return new Promise(resolve => {
            ...
            sourceElements.forEach(srcEl => {
                ...
                particle.style.cssText = `
                    ...
                    height: 36px;
                    border-radius: 50%;
                    background: radial-gradient(circle, #7fff7f, #00ff00);
            ...
            if (targetElement) {
                ...
                targetElement.style.boxShadow = '0 0 60px 20px #0f0';
    ...
    async function executeMergePlan(plan, my) {
        ...
        if (plan.type === 'character') {
            ...
            await playFlyAnimation(sourceEls, targetEl, 600);
            ...
            await playFlyAnimation(handEls, boardEl, 600);
    ...
    function updateMergeGlow() {
        ...
        // 稀有度对应的光效颜色
        const rarityColors = {
            'Common':    '0 0 15px 4px #00ff00',   // 绿色
            'Rare':      '0 0 15px 4px #0080ff',   // 蓝色
            'Epic':      '0 0 15px 4px #ff8800',   // 橙色
            'Legendary': '0 0 15px 4px #ff2222'    // 红色
        };
        ...
        document.querySelectorAll(selectors.join(',')).forEach(el => {
            ...
            if (card && canMerge(card)) {
                const color = rarityColors[card.rarity] || rarityColors['Common']; // 默认绿色

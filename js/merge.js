...
window.mergeService = (function() {
    ...
    // 播放粒子飞行动画
    function playFlyAnimation(sourceElements, targetElement, duration = 500) {
        return new Promise(resolve => {
            ...
            if (targetElement) {
                ...
                targetElement.style.boxShadow = '0 0 30px 10px #0f0';
    ...
    async function executeMergePlan(plan, my) {
        ...
        if (plan.type === 'character') {
            ...
            // 播放飞行特效
            await playFlyAnimation(sourceEls, targetEl, 500);
            ...
            await playFlyAnimation(handEls, boardEl, 500);

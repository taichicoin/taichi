...
window.mergeService = (function() {
    ...
    function getVisibleShopCards(my) {
        ...
        const start = sub * 3;                     // 当前页起始索引 (0,3,6,9,12)
    ...
    function findMergePlan(my) {
        ...
        for (const key in characterGroups) {
            ...
            if (group.length >= 3) {
                ...
                return {
                    ...
                    targetIndex,
                    newCard,
                    rarity: mergeTargets[0].card.rarity || 'Common'   // 记录稀有度
                };
            }
        }
        ...
        for (const key in weaponGroups) {
            ...
            const newWeapon = {
                ...
                rarity: oldWeapon.rarity || 'Common'   // 保留稀有度
            };
            return {
                type: 'weapon',
                equippedInfo,
                ...
                newWeapon,
                boardCard,
                rarity: oldWeapon.rarity || 'Common'    // 记录稀有度
            };
        }
        return null;
    }
        ...
        return new Promise(resolve => {
            ...
            sourceElements.forEach(srcEl => {
                ...
                particle.style.cssText = `
                    ...
                    height: 36px;
                    border-radius: 50%;
                    background: radial-gradient(circle, rgba(255,255,255,0.6), ${colorHex});
    ...
    function updateMergeGlow() {
        ...
        document.querySelectorAll(selectors.join(',')).forEach(el => {
            ...
            if (card && canMerge(card)) {
                ...
                // 内部铺满半透明颜色（20%透明度），保留原有边框样式
                el.style.boxShadow = `inset 0 0 0 1000px rgba(${colors.rgba}, 0.2)`;
            } else {
                el.style.boxShadow = '';
            }
        });

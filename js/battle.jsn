...
window.YYCardBattle = (function() {
    ...
    // ★ 确保进度条和跳过按钮存在（插入到棋盘中间的 wrapper 里）
    function ensureSkipUI() {
        ...
        skipBtn.style.cssText = `
            display: none; background: rgba(20, 28, 48, 0.9); color: #f5d76e;
            border: 1px solid #f5d76e; border-radius: 6px; padding: 4px 12px;

// ==================== 刷新 & 升级动作模块 (refresh.js · 页码保护版 · 操作锁) ====================
window.YYCardShopRefresh = (function() {
    ...
    async function refreshShopAction() {
        // 操作锁：如果已有操作进行中，直接返回
        if (window.YYCardShop?.operationLock || isRefreshingShop) return;
    ...
    function init(deps) {
        ...
        bindEvents();
        console.log('✅ refresh.js 已启动（绝对页码驱动 + 持久化保护 + 操作锁）');
    }

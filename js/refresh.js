...
window.YYCardShopRefresh = (function() {
    ...
    function playBuffOnCard(cardElement, atkBuff, hpBuff) {
        ...
        if (atkBuff > 0) createFloatText(floatContainer, `+${atkBuff}`, '#00ff00');
        if (hpBuff > 0) createFloatText(floatContainer, `+${hpBuff}`, '#00ff00');

...
window.YYCardShopRefresh = (function() {
                ...
                .then(result => {
                    ...
                    if (isSwitchingGroup) {
                        if (result.success && result.data.updatedPlayer) {
                            ...
                            // 注意：不再调用 _renderShop()，因为 performLocalFlip 已经渲染了新组
    ...
    function init(deps) {
        ...
        bindEvents();
        console.log('✅ refresh.js 已启动（原版逻辑，绝对稳定）');
    }

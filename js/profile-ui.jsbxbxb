...
window.YYCardProfileUI = {
    ...
    update() {
        ...
        // ★ 头像始终使用 profile 中的 avatar_url（由 Google 登录时写入）
    ...
    // ★ 以下两个方法（_onChangeAvatar, _uploadAvatar）已完全移除
...
console.log('✅ 头像菜单已移除修改头像功能，仅保留Google头像');

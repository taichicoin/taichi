...
window.YYCardBattle = (function() {
    ...
    async function launchBattleAnimation() {
        ...
        // 如果本回合已经结算过，直接切换到准备界面，并自动补发个人奖励
    ...
    async function enterBattle(roomId) {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            if (state) {
                ...
                // 如果在战斗阶段，进入动画检查（内部会根据lastSettledRound决定是否播放）

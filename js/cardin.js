...
window.YYCardInspector = (function() {
    ...
    function showCardDetail(card, boardIndex, element, isOwn) {
        ...
        function buildSkillHTML(currentCard) {
            ...
            return `
                <div style="margin-bottom:8px;">
                    <!-- 卡牌名字 -->
                    <div style="font-size: clamp(1rem, 4vw, 1.5rem); font-weight: bold; margin-bottom: 4px; word-break: break-all;">
                        ${name}
                    </div>
                    <!-- 标签行：稀有度、阵营、内力（护盾已在卡牌上） -->
                ...
                ${skillInfo ? `
                <div class="inspect-skill" style="background:rgba(255,255,255,0.08); border-radius:8px; padding:8px; max-height:120px; overflow-y:auto;">
                ...
                </div>` : '<div style="color:#aaa;">无技能</div>'}
            `;
        }
        ...
        skillContainer.style.cssText = 'flex:1; min-width:0;';
    ...
    function init() {
        ...
        console.log('✅ 卡牌查看系统已启动（左卡牌，右名字+技能，下装备/增益）');
    }

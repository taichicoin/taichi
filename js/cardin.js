...
window.YYCardInspector = (function() {
    ...
    function showCardDetail(card, boardIndex, element, isOwn) {
        ...
        // 生成右侧详情 HTML（名字阵营稀有度内力同一行，技能固定高度）
        function buildSkillHTML(currentCard) {
            ...
            return `
                ...
                ${skillInfo ? `
                <div class="inspect-skill" style="background:rgba(255,255,255,0.08); border-radius:8px; padding:8px; height:100px; overflow-y:auto;">
                ...
                </div>` : '<div style="color:#aaa; height:100px; display:flex; align-items:center; justify-content:center;">无技能</div>'}
            `;
        }
    ...
    function init() {
        ...
        console.log('✅ 卡牌查看系统已启动（固定高度、装备大图）');
    }

// ==================== 卡牌查看系统（支持装备显示与卸下、点击外部关闭）修复版 ====================
window.YYCardInspector = (function() {

    // ---------- 清理所有残留弹窗（仅弹窗，不碰棋盘）----------
    function cleanupAllRemnants() {
        // 只移除弹窗自身，不再清除 .card-drag-clone 以免误删棋盘卡牌
    ...
    function init() {
        ...
        console.log('✅ 卡牌查看系统已启动（装备/卸下支持，已修复棋盘卡牌消失）');
    }

...
window.YYCardBattle = (function() {
    ...
    function initDebugPanel() {
        ...
        p.style.cssText = `
            position:fixed; top:0; left:0; right:0; max-height:220px; overflow-y:auto;
            ...
            display: flex; flex-direction: column-reverse;  /* 新日志出现在底部 */
        `;
    ...
    function logToScreen(msg, isError = false) {
        ...
        // 由于使用了 flex-direction: column-reverse，新日志插入到顶部（视觉上在底部）

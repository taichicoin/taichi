...
window.YYCardShop = (function() {
    ...
    // ==================== ★ 商店刷新（最终版：300ms防连点 + 仅更新buffer，金币不回弹） ====================

...
window.YYCardBattle = (function() {
    ...
    function createCardElement(card) {
        ...
        // 图片路径兼容多种字段
        const imgPath = card.icon || card.image || `/assets/card/${card.cardId || card.id || 'default'}.png`;
        
        d.innerHTML = `
            <div class="card-icon">
                <img src="${imgPath}" alt="${card.name}" onerror="this.src='/yycard/assets/default-avatar.png'">
            </div>
...
console.log('✅ battle.js 加载完成（图片显示修复版）');
